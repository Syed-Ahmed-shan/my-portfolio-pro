...
export default function Intro() {
  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative">
        
        {/* Left Content (Text) */}
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left relative z-10 w-full lg:p-0">
          <div className="overflow-hidden mb-6 mt-4 lg:mt-0">
            <motion.div
          ...
          <motion.div
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-tight mb-6 h-[120px] sm:h-[180px] md:h-[220px] lg:h-[280px]"
          >
        ...
        {/* Right Content for Desktop / Top Content for Mobile */}
        <motion.div 
        ...
        >
          ...
          <div className="relative group w-[240px] h-[320px] sm:w-[300px] sm:h-[400px] md:w-[400px] md:h-[500px] lg:w-[450px] lg:h-[550px] rounded-[2.5rem] p-[2px] overflow-hidden hover:scale-[1.02] transition-transform duration-500 shadow-2xl">
